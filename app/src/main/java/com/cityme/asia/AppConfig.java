...
public class AppConfig {
    ...
    public static final String SMALL_RES = "Quán ăn";
    public static final String RESTAURANT = "Nhà hàng";
    public static final String BAR_PUB = "Bar/Pub";
    public static final String BEER_PUB = "Quán bia";
    public static final String STREET_FOOD = "Ăn vặt";
